...
df_map = pd.read_excel('/Users/gabriel.gomes/Desktop/DV_project/dataset_payments (1).xlsx',
                       sheet_name='POS_country_2022')  # Local storage - Change later

# Load data for bar plot
# df_bar = pd.read_excel('dataset_payments.xlsx', sheet_name='POS_demo_2022')
df_bar = pd.read_excel('/Users/gabriel.gomes/Desktop/DV_project/dataset_payments (1).xlsx',
...
data_number = pd.read_csv('/Users/gabriel.gomes/Desktop/DV_project/Multipage_App/datasets/data_df_1.csv')
data_value = pd.read_csv('/Users/gabriel.gomes/Desktop/DV_project/Multipage_App/datasets/data_df_2.csv')
